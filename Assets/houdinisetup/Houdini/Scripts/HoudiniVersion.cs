...
public struct HoudiniVersion
{
	...
	public const int HOUDINI_BUILD			= 632;
	...
	public const string HAPI_SERVER			= "/Library/Frameworks/Houdini.framework/Versions/15.5.632/Resources/bin/" + "HARS";
	#if UNITY_EDITOR_64 || UNITY_64
		public const string HAPI_LIBRARY	= "/Library/Frameworks/Houdini.framework/Versions/15.5.632/Libraries/" + "libHARC.dylib";
	#else
		public const string HAPI_LIBRARY	= "/Library/Frameworks/Houdini.framework/Versions/15.5.632/Libraries/" + "libHARC32.dylib";
	#endif // UNITY_EDITOR_64

#elif UNITY_STANDALONE_LINUX

	public const string HAPI_SERVER			= "/opt/hfs15.5.632/dsolib/" + "HARS";
	public const string HAPI_LIBRARY		= "/opt/hfs15.5.632/bin/" + "libHARC.so";
